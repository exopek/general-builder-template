<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-100 px-4 sm:px-6 lg:px-8">
      ...
      <form @submit.prevent="handleLogin" class="mt-8 space-y-6">
        ...
        <div>
          <button
            ...
            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div class="text-center">
          <NuxtLink to="/" class="text-sm text-orange-600 hover:text-orange-500">
