...
const faqProps = {
  ...
  showBadge: true,
  headline: 'Alles über unser Gym in Linden',
  subheadline: 'Häufige Fragen zu EXOPEK, Morgentraining und unserem Fitnessstudio Hannover Linden',

  // Settings
  showSearch: true,
  searchPlaceholder: 'Nach Thema suchen...',
  showCategories: true,
