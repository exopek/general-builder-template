        ...
        <div class="hidden md:block overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
          <table class="w-full">
            <thead>
              <tr class="bg-gray-50">
                <th class="px-6 py-4 text-left">
                  <span class="text-lg font-bold text-gray-900">{{ leftColumnTitle }}</span>
                </th>
                <th class="px-6 py-4 text-center bg-gradient-to-br from-orange-500 to-red-600">
                  <div class="flex items-center justify-center gap-2">
                    ...
                    <span class="text-lg font-bold text-white">{{ rightColumnTitle }}</span>
                  </div>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              >
                <td class="px-6 py-4">
                  <p class="font-semibold text-gray-900 mb-1">{{ row.feature }}</p>
                  <p class="text-sm text-gray-600">{{ row.traditional }}</p>
                </td>
                <td class="px-6 py-4 bg-orange-50">
                  <div class="flex items-center justify-center gap-3">
                    ...
                    <p class="font-semibold text-gray-900">{{ row.exopek }}</p>
                  </div>
                </td>
              </tr>
            </tbody>
        ...
        <div class="md:hidden space-y-6">
          ...
          >
            ...
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
              <h3 class="font-bold text-gray-900 text-lg">{{ row.feature }}</h3>
            </div>

            <!-- Traditional -->
            <div class="px-6 py-4 border-b border-gray-200">
              <p class="text-sm font-semibold text-gray-500 mb-2">{{ leftColumnTitle }}</p>
              <p class="text-gray-700">{{ row.traditional }}</p>
            </div>
            ...
            <div class="px-6 py-4 bg-gradient-to-br from-orange-50 to-white">
              <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-sm font-semibold text-orange-600">{{ rightColumnTitle }}</p>
              </div>
