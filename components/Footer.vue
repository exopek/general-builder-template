      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 lg:col-span-2">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-2xl font-bold">FitGym</h3>
          </div>
          <p class="text-gray-300 mb-6 max-w-md">
            Dein modernes Fitnessstudio mit professioneller Ausstattung und qualifizierten Trainern. 
            Erreiche deine Fitnessziele in einer motivierenden Atmosphäre.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="/" class="text-gray-300 hover:text-white transition-colors">Start</a></li>
            <li><a href="/kurse" class="text-gray-300 hover:text-white transition-colors">Kurse</a></li>
            <li><a href="/preise" class="text-gray-300 hover:text-white transition-colors">Preise</a></li>
      ...
      <div class="container mx-auto px-4 py-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
          <p class="text-gray-400 text-sm">
            © 2024 FitGym. Alle Rechte vorbehalten.
          </p>
          <div class="flex gap-6 text-sm">
            <a href="/datenschutz" class="text-gray-400 hover:text-white transition-colors">Datenschutz</a>
            <a href="/impressum" class="text-gray-400 hover:text-white transition-colors">Impressum</a>
            <a href="/agb" class="text-gray-400 hover:text-white transition-colors">AGB</a>
          </div>
        </div>
      </div>
    </div>
