    ...
    <div class="container mx-auto px-4 md:px-6">
      ...
      >
        ...
        <div
          ...
          :key="`top-${index}`"
          class="gallery-item relative overflow-hidden rounded-2xl cursor-pointer group"
        ...
        <div
          ...
          class="gallery-item relative overflow-hidden rounded-2xl cursor-pointer group md:col-span-2 lg:col-span-3"
