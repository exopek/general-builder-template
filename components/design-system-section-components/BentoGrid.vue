    ...
    <div class="container mx-auto px-4 md:px-6">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div
          ...
          :style="{
            backgroundColor: featuredCard.backgroundColor || '#f3f4f6',
            aspectRatio: '4/5'
          }"
        >
          <!-- Image Card -->
          ...
          >
            <h3
              ...
              :style="{ color: featuredCard.textColor || '#ffffff' }"
              v-html="featuredCard.heading"
            ></h3>
            <div
              v-if="featuredCard.description"
              class="text-sm md:text-base mb-4"
              :style="{ color: featuredCard.textColor || '#ffffff' }"
              v-html="featuredCard.description"
            ></div>
            <Button
